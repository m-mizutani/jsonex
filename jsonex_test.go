...
func TestJsonex_UnicodeAndEscapes(t *testing.T) {
...
func TestJsonex_DeepNesting(t *testing.T) {
...
func TestJsonex_MixedArrays(t *testing.T) {
...
func TestJsonex_ErrorScenarios(t *testing.T) {
	tests := []struct {
		name        string
		data        []byte
		expectError bool
...
func TestJsonex_OptionsValidation(t *testing.T) {
...
func TestJsonex_SpecialCharacters(t *testing.T) {
